...
Input data is provided in the file "Input_data.RData", which is automatically loaded in. This file contains the mutation densities at MRCA and ECA, along with the 95% CI bounds as  estimated in the manuscript. 
