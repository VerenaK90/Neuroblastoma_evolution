...
for(i in 1:length(primary.of.tumor.pairs)){
  ...
  ## ploidy/purity:
  aceseq.prim <- list.files(paste0(data.directory.80x, "/", prim, "/", cnv.directory, "/"), pattern="comb_pro_extra")[1]
  ...
  aceseq.rec <- list.files(paste0(data.directory.80x, "/", relapse, "/", cnv.directory, "/"), pattern="comb_pro_extra")[1]
  ...
  files.prim <- list.files(paste0(data.directory.80x, "/", prim, "/", snv.directory, "/"), pattern="somatic_snvs_conf_8_to_10")[1]
  
  mutations.prim <- read.vcf(paste0(data.directory.80x, "/", prim, "/", files.prim))
  ...
  files.rec <- list.files(paste0(data.directory.80x, "/", relapse,  "/", snv.directory, "/"), pattern="somatic_snvs_conf_8_to_10")[1]
  mutations.rec <- read.vcf(paste0(data.directory.80x, "/", relapse,  "/", snv.directory, "/", files.prim))
  ...
  copy.number.info.prim <- read.delim(file=paste0(data.directory.80x, "/", prim, "/", cnv.directory, "/", aceseq.prim), sep="\t", stringsAsFactors = F)
