...
r = R("~/pyABC/XTEN/Initiation/Expansion_homeostasis_continuous_evol.R")
...
prior = Distribution(delta1=RV("uniform", 0, 0.9), N=RV("uniform", 3, 6), psurv=RV("uniform", 0.01, 0.49), muD1=RV("uniform", -9, 5), muD2 = RV("uniform", -9, 5), mu = RV("uniform", 1, 14), r = RV("uniform", 0, 0.999))
...
db = "sqlite:///" + "~/pyABC/XTEN/Initiation/Expansion_homeostasis_continuous_evol.db"
