...
not.dateable <- data.frame(Gain = "17q",
                           Sample = rownames(sample.information.80x)[sample.information.80x$`17q.gain`=="T" & sample.information.80x$`17q.gain.<.5`=="F"])
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "17",
                           Sample = rownames(sample.information.80x)[sample.information.80x$`17.gain`=="T" & sample.information.80x$`17.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "7q",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`7q.gain`=="T" & sample.information.80x$`7q.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "7",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`7.gain`=="T" & sample.information.80x$`7.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "1q",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`1q.gain`=="T" & sample.information.80x$`1q.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "1",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`1.gain`=="T" & sample.information.80x$`1.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "2p",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`2p.gain`=="T" & sample.information.80x$`2p.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "2",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`2.gain`=="T" & sample.information.80x$`2.gain.<.5`=="F"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "11q",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`11q.deletion`=="T"]))
not.dateable <- rbind(not.dateable,
                      data.frame(Gain = "1p",
                                 Sample = rownames(sample.information.80x)[sample.information.80x$`1p.deletion`=="T"]))
...
## read in annotation
gains.losses.eca <- data.frame(CHROM=1, SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_1 %in% c("ECA", "ECA/MRCA"),]))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="1p", 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1p %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="1q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1q %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="2", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_2 %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="2p", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_2p %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="7", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_7 %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="7q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_7q %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="11q", 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_11q %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="17", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_17 %in% c("ECA", "ECA/MRCA"),])))
gains.losses.eca <- rbind(gains.losses.eca, data.frame(CHROM="17q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_17q %in% c("ECA", "ECA/MRCA"),])))
...
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, 
                                       data.frame(CHROM=rep(1, sum(sample.information.80x$Timing_whole_1 %in% c("early tetraploid"))), SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_1 %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, 
                                       data.frame(CHROM=rep("1p", sum(sample.information.80x$Timing_1p %in% c("early tetraploid"))), SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1p %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("1q", sum(sample.information.80x$Timing_1q %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1q %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("2", sum(sample.information.80x$Timing_whole_2 %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_2 %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("2p", sum(sample.information.80x$Timing_2p %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_2p %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("7", sum(sample.information.80x$Timing_whole_7 %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_7 %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("7q", sum(sample.information.80x$Timing_7q %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_7q %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, 
                                       data.frame(CHROM=rep("11q", sum(sample.information.80x$Timing_11q %in% c("early tetraploid"))), SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_11q %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("17", sum(sample.information.80x$Timing_whole_17 %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_17 %in% c("early tetraploid"),])))
gains.losses.early.tetraploid <- rbind(gains.losses.early.tetraploid, data.frame(CHROM=rep("17q", sum(sample.information.80x$Timing_17q %in% c("early tetraploid"))), 
                                                       SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_17q %in% c("early tetraploid"),])))


gains.losses.mrca <- data.frame(CHROM=1, SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_1 %in% c("MRCA", "ECA/MRCA"),]))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="1p", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1p %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="1q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1q %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="2", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_2 %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="2p", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_2p %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="7", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_7 %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="7q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_7q %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="11q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_11q %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="17", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_17 %in% c("MRCA", "ECA/MRCA"),])))
gains.losses.mrca <- rbind(gains.losses.mrca, data.frame(CHROM="17q", 
                                                         SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_17q %in% c("MRCA", "ECA/MRCA"),])))


gains.losses.late.tetraploid <- data.frame(CHROM=c(), SAMPLE=c())
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, 
                                       data.frame(CHROM=rep(1, sum(sample.information.80x$Timing_whole_1 %in% c("late tetraploid"))), SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_1 %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("1q", sum(sample.information.80x$Timing_1q %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1q %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("1p", sum(sample.information.80x$Timing_1p %in% c("late tetraploid"))), 
                                                                               SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_1p %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("2", sum(sample.information.80x$Timing_whole_2 %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_2 %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("2p", sum(sample.information.80x$Timing_2p %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_2p %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("7", sum(sample.information.80x$Timing_whole_7 %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_7 %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("7q", sum(sample.information.80x$Timing_7q %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_11q %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("11q", sum(sample.information.80x$Timing_11q %in% c("late tetraploid"))), 
                                                                               SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_7q %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("17", sum(sample.information.80x$Timing_whole_17 %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_whole_17 %in% c("late tetraploid"),])))
gains.losses.late.tetraploid <- rbind(gains.losses.late.tetraploid, data.frame(CHROM=rep("17q", sum(sample.information.80x$Timing_17q %in% c("late tetraploid"))), 
                                                                                 SAMPLE=rownames(sample.information.80x[sample.information.80x$Timing_17q %in% c("late tetraploid"),])))
...
matrix.early.late <- matrix("", nrow=10+length(unique(driver.genes)),
                            ncol=length(tumors.80x), dimnames=list(c(unique(driver.genes),
...
to.replace <- sample.information.80x[colnames(matrix.early.late), "ATRX"]## check the nonframeshift deletion
...
matrix.early.late["MYCN",sample.information.80x[colnames(matrix.early.late),"Subtype"]=="MNA"] <- paste(matrix.early.late["MYCN",sample.information.80x[colnames(matrix.early.late),"Subtype"]=="MNA"], "AMP", sep=";")
matrix.early.late["TERT",sample.information.80x[colnames(matrix.early.late),"Subtype"]=="TERT"] <- paste(matrix.early.late["TERT",sample.information.80x[colnames(matrix.early.late),"Subtype"]=="TERT"], "SV", sep=";")
...
matrix.early.late["MYCN","NBE19-AUT-3"] <- "AMP"
