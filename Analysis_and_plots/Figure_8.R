...
## store figure panels
panel.directory <- paste0(output.directory, "Figure8/")
...
##############################################################################################################################################
## Figure 8a Expansion + homeostasis
...
##############################################################################################################################################
## Figure 8d Expansion + decay, MRCA
...
pdf(paste0(panel.directory, "Figure_8d.pdf"), width=5, height=3)
print(ggplot(to.plot, aes(x=x, y = data, ymin = data-sd, ymax = data +sd, col=Event, fill=Event)) + geom_step() + geom_errorbar()+
        geom_stepribbon(aes(x=x, ymin = lower, ymax = upper), alpha=0.5)  +
...
##############################################################################################################################################
##### Figure 8e, S5b Plot the retraction of neuroblasts and the exapnsion of the first clone over approximate week of pregnancy
...
##############################################################################################################################################
## Figure 8f: effective mutation rate
...
pdf(paste0(panel.directory, "Figure_8f.pdf"), width = 5, height=4)
...
##############################################################################################################################################
## Figure 8g: relative loss rates

pdf(paste0(panel.directory, "Figure_8g.pdf"), width = 5, height=4, useDingbats = F)
...
saveWorkbook(wb, file = paste0(panel.directory, "Source_data_Fig.8.xlsx"), overwrite=T)
