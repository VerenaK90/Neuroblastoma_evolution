...
##############################################################################################################################################
## Figure S3a; parameter estimates

pdf(paste0(panel.directory, "Figure_S3a.pdf"), width=7, height=7, useDingbats = F)
...
##############################################################################################################################################
##### Figure 6f, S3b Plot the retraction of neuroblasts and the exapnsion of the first clone over approximate week of pregnancy
...
writeData(wb.s, "b_Neuroblasts", N.sim.cells)
addWorksheet(wb.s, "b_M1_cells")
writeData(wb.s, "b_M1_cells", M1)

pdf(paste0(panel.directory, "Figure_S3b.pdf"), width=7, height=7, useDingbats = F)
